...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_APirio')
	 Begin 
	  Alter Database [Assignment06DB_APirio] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_APirio;
	 End
	Create Database Assignment06DB_APirio;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_APirio;
...
as
select top 1000000 I.InventoryDate, E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName
...
as
select top 1000000 C.CategoryName, P.ProductName, I.InventoryDate, I.[count], E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName
from vInventories as I 
	inner join vEmployees as E
	 on I.EmployeeID = E.EmployeeID
	inner join vProducts as P
